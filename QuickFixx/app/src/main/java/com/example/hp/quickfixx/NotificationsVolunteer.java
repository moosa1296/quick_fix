 ...
 */
public class NotificationsVolunteer extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container,
        ...
        final DatabaseReference databaseReference = firebaseDatabase.getReference("users").child(VolunteerMainActivity.UserEmail.replace(".",","));
        ...
        readData(VolunteerMainActivity.UserEmail);
        ...
        handler.postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    jsonObject.put("userEmail",VolunteerMainActivity.UserEmail.replace(".",","));
